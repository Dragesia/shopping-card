...
const initialCart = localStorage.getItem('cart') !== null ? JSON.parse(localStorage.getItem('cart')) : [];
    ...
    <>
      ...
      <Routes>
        ...
        <Route path='/catalog' element={<Sidebar {...{category, setCategory}}/>}>
          <Route index element={<Products products={products} handleAddToCart={handleAddToCart}/>} />
          <Route path='movies' element={<Movies movies={products[0].items} handleAddToCart={handleAddToCart}/>} />
          <Route path='series' element={<Series series={products[1].items} handleAddToCart={handleAddToCart}/>} />
          <Route path='games' element={<Games games={products[2].items} handleAddToCart={handleAddToCart}/>} />
        </Route>
